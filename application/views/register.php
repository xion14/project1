            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form class="user" action="<?php echo base_url() ?>register" method="POST">
                    ...
                    <div class="form-group">
                      <input type="text" name="nama_lengkap" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Nama Lengkap...">
                    </div>
                    
                    <input type="submit" class="btn btn-primary btn-user btn-block">
                    <a href="<?php echo base_url() ?>" class="btn btn-danger btn-user btn-block">LOGIN</a>
